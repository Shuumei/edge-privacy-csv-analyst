...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border/60 transition-colors odd:bg-white even:bg-slate-50/40 hover:bg-slate-100/70 data-[state=selected]:bg-muted",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 px-4 text-left align-middle font-semibold text-slate-800 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
